...
In this webpage, we provide audio examples of the one-bar drum loops and one-bar synth loops generated by different generative models, including StyleGAN2, ProjectedStyleGAN2 (VGG), and ProjectedStyleGAN2 (SCNN on Loop) and ProjectedStyleGAN2 (Fusion).
